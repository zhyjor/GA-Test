...
public class GA_Pipenet {
    ...
    private Algo_Model_link_Opti_Model amlm;//连接计算模型的类
    ...
    public void start() {
        ...
        double fit = new GA_Pipenet.MaxValue(bestresult).fitness();
        output(fit, X);
    }
    ...
    synchronized private ElitisticListPopulation randomPopulation() {
        ...
        for (int i = 0; i < POPULATION_SIZE; i++) {
            BinaryChromosome randChrom = new GA_Pipenet.MaxValue(BinaryChromosome.randomBinaryRepresentation(DIMENSION));
