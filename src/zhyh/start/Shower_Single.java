...
import zhyh.Tool.Estimater.Estimater_Well_InfluenceRate;
...
//        }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        well.add("A1-011");
        new Shower_Single().estimate(well, "");//region=“”时默认为显示全部区域的井，
