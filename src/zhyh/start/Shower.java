...
import zhyh.Tool.Shower.CalibrationSpiderWebPlot_Auxiliary;
import zhyh.Tool.Shower.CalibrationSpiderWebPlot_User;
...
public class Shower {
     ...
     */
    public Shower(String[] item_name) {
